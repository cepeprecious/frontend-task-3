...
{{-- <div class="relative overflow-hidden bg-cover bg-no-repeat" style="background-position: 50%; background-image: url('img/bg-1.jpg'); height: 900px;">
        ...
        <div class="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-fixed">
            <div class="flex h-full w-full md:w-3/5 items-center justify-center">
                <div class="px-6 text-white md:px-12">
                    ...
                    <button type="button" class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md font-medium bg-orange-600 text-white hover:bg-blue-600 text-lg">
                        Discover More
                    </button>
                </div>
            </div>
        ...
        <div class="p-1">
            <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                <a href="#" class="lightbox transition-all duration-500 group-hover:scale-105 tobii-zoom" title="">
                    <img src="https://ik.imagekit.io/ktdjfymfk/pexels-pixabay-261102_jrR28DpHn.jpg?ik-sdk-version=javascript-1.4.3&updatedAt=1654163119529">
                </a>
    ...
    {{-- <div class="h-screen flex justify-center items-center">
        <div class="p-1">
            <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                ...
                <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 group-hover:bottom-2 transition-all duration-500">
                    <i class="fa-solid fa-link text-black text-4xl"></i>
                </div>
            </div>
        </div>
    </div> --}}
        ...
        <div class="grid gap-x-28 row-gap-10 lg:grid-cols-2 md:px-12 lg:px-0">
            <div class="flex flex-col justify-start">
                <div class="lg:max-w-xl mb-6">
                    <h1 class="text-2xl text-gray-900 font-bold md:text-4xl" style="font-family: 'Oswald', sans-serif;">Welcome to EQISI Excel Quality Integrated Solutions</h1>
            ...
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4">
                    <div class="mx-auto mb-12 max-w-[510px] text-center lg:mb-20 text-white">
                        <h2 class="text-5xl font-bold md:text-5xl md:leading-tight" style="font-family: 'Oswald', sans-serif;">Our Services</h2>
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
            <h2 class="text-5xl font-bold md:text-5xl md:leading-tight" style="font-family: 'Oswald', sans-serif;">Blogs</h2>
            <p class="mt-5 text-xl text-orange-600" style="font-family: 'Roboto Flex', sans-serif; font-weight: 500">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a class="group flex flex-col h-full hover:border-transparent hover:text-orange-500" href="#">
                ...
                <div class="my-6">
                    ...
                    <p class="mt-3 text-lg font-semibold">
                        When the business can no longer meet the demands of its short/long.
                    </p>
                </div>
            </a>
            <!-- End Card -->
                ...
                <div class="mt-12">
                    ...
                    <form>
                        ...
                        <div class="mt-10 grid">
                            <button type="submit" class="w-40 inline-flex justify-center items-center gap-x-3 text-center text-sm lg:text-xl text-white font-semibold rounded-md transition py-3 px-4" style="background-color: #e25923">Submit</button>
                        </div>
                    </form>
                    <!-- End Form -->
                </div>
